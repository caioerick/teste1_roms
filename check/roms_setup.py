...
# a biblioteca na versao do matplotlib que to usando, e no codigo eu nao preciso dela

#from matplotlib.mlab import griddata
# o pacote griddata do matplotlib foi descontinuado
...
def add_topo(lon, lat, pm, pn, toponame):
	...
	h = griddata((x.ravel(),y.ravel()),h.ravel(), (lon,lat), method='nearest')
...
def zlevs(h,zeta,theta_s,theta_b,hc,N,type):
    ...
    # Essa linha ta dando problema com identacao
    # ... entao, hoje, 16 de jul de 2019, estou
    # comentando esse bloco ate o dia que eu
    # precise utilizar essa funcao
...
def rotfilter(h, maskr, hmax_coast, rmax):
	"""
	#
	# Apply a selective filter on log(h) to reduce grad(h)/h. aa
	# 
	"""
